...
class ChopperScape(Env, ABC):
    ...
    def draw_elements_on_canvas(self):
        ...
        text = 'Generation: {} | Fuel Left: {} | Rewards: {}'.format(self.generation, self.fuel_left, self.ep_return)
    ...
    def render(self, mode="human"):
        ...
        if mode == "human":
            cv2.imshow("Chopper Game", self.canvas)
            cv2.waitKey(10)
...
class Fuel(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("assets/fuel.png") / 255.0
        self.icon_w = 32
        self.icon_h = 32
        self.icon = cv2.resize(self.icon, (self.icon_h, self.icon_w))
